...
void test_operator(std::string str, OperatorKind real) { auto value = test_token(str, real); }
...
void test() {
	...
	test_operator("&&", OperatorKind::LogicalAnd);
	test_operator("||", OperatorKind::LogicalOr);
	test_operator("!", OperatorKind::Not);
